...
public class IcmpV6EchoReplyPacketTest extends AbstractPacketTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(IcmpV6EchoReplyPacketTest.class);
    ...
    public void testNewPacket() {
        try {
            IcmpV6EchoReplyPacket p =
                    IcmpV6EchoReplyPacket.newPacket(packet.getRawData(), 0, packet.getRawData().length);
